...
export class ApiComponent implements OnInit{
  ...
  images = [
    ...
    { url: "https://cloudserviceimgstorage.blob.core.windows.net/images/stripePayment.svg", title: "STRIPE PAYMENT", alt: "Sjtripe Payment Api", description: "Collect payments from your clients, for your available products and services.", link: "https://stripe.com/en-ca" },
